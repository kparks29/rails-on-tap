...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { ABV: @beer.ABV, brewery: @beer.brewery, name: @beer.name, price: @beer.price, type: @beer.type }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { ABV: @beer.ABV, brewery: @beer.brewery, name: @beer.name, price: @beer.price, type: @beer.type }
    assert_redirected_to beer_path(assigns(:beer))
  end
